...
import {createClothes, fetchBrands, fetchClothes, fetchTypes} from "../../http/clothesAPI";
    ...
    return (
        ...
        >
            ...
            <Modal.Body>
                <Form>
                    <Dropdown className="mt-2 mb-2">
                        <Dropdown.Toggle>{clothes.selectedType.name || "Choose type"}</Dropdown.Toggle>
                        <Dropdown.Menu>
                    ...
                    <Dropdown className="mt-2 mb-2">
                        <Dropdown.Toggle>{clothes.selectedBrand.name || "Choose brand"}</Dropdown.Toggle>
                        <Dropdown.Menu>
            ...
            <Modal.Footer>
                ...
                <Button variant="outline-success" onClick={addClothes}>Add</Button>
            </Modal.Footer>
        </Modal>
    );
});
